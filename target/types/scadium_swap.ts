 ...
 * IDL can be found at `target/idl/scadium_swap.json`.
 */
export type ScadiumSwap = {
  "address": "9Fog7cFRQiPfszYu1ioFdqQDwmmTd6SZpkyb8hyo13dU",
  "metadata": {
    "name": "scadiumSwap",
    "version": "0.1.0",
    "spec": "0.1.0",
    "description": "Scadium SCAD/SOL constant-product pool"
  },
  "instructions": [
    {
      "name": "addLiquidity",
