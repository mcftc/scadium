...
exports.crashMultiplierAt = crashMultiplierAt;
exports.crashTimeForMultiplier = crashTimeForMultiplier;
 ...
 */
function crashMultiplierAt(tMs, growthRate = 1.00024) {
    if (tMs <= 0)
        return 1.0;
 ...
 */
function crashTimeForMultiplier(multiplier, growthRate = 1.00024) {
    if (multiplier <= 1)
        return 0;
